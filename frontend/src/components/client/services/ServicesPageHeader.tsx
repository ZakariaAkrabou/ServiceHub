  ...
  return (
    <section className="sph">
      <style>{`
        ...
        .sph__btn:hover .sph__btn-arrow { transform: translateX(3px); }
        ...
        @media (max-width: 600px) {
          .sph { padding: 100px 20px 80px; }
          .sph__stats { gap: 28px; }
          .sph__stat-sep { display: none; }
          .sph__btn { padding: 13px 24px; font-size: 13px; }
        }
      `}</style>

      <canvas ref={canvasRef} className="sph__canvas" />
      <div className="sph__grid" />
      ...
      <div className="sph__inner">
        ...
        {/* Divider */}
        <div className="sph__divider" />

        {/* Copy */}
        <p className="sph__copy">
          Discover a wide range of <em>professional services</em> tailored to your needs —
          from home repairs to wellness, we connect you with trusted experts
          who deliver quality and reliability every single time.
        </p>
      ...
      {/* Scroll hint */}
      <div className="sph__scroll">
        <div className="sph__scroll-bar" />
        Scroll
      </div>
    </section>
  );
