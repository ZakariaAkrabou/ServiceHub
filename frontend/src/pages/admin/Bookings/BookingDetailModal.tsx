      ...
      <div className="relative w-full max-w-2xl bg-white rounded-3xl shadow-xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="h-24 bg-gray-50 border-b border-gray-100 flex items-start justify-between px-6 pt-6">
          <div className="flex items-center gap-4">
            <div
              className="w-16 h-16 rounded-2xl flex items-center justify-center text-[#081D3A] bg-[#F3F3F3] font-bold text-2xl shadow-sm border-2 border-white -mt-2"
            >
              {booking.avatar}
            </div>
            <div className="pb-2">
              <h3 className="text-xl font-bold text-[#081D3A] leading-tight">Booking #{booking.id}</h3>
              <div className="flex items-center gap-2 mt-1">
                <span className={`inline-flex shrink-0 items-center justify-center text-[10px] font-bold px-2 py-0.5 rounded-md uppercase tracking-wider ${booking.status === 'Completed' ? 'bg-green-100 text-green-700' :
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3 text-sm text-gray-700">
                ...
                <div>
                  <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Provider / Service</p>
                  <p className="font-semibold text-gray-900">{booking.provider} &bull; <span className="text-gray-600 font-normal">{booking.serviceName}</span></p>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-3.5 text-[13px] text-blue-800 font-medium">
                ...
                {booking.status === "Pending" && " Administrator review or provider confirmation may be required."}
              </div>
            </div>
